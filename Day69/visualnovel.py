...
start = tk.PhotoImage(file="visualNovel/I-1.png")
start = start.subsample(4)
codes = tk.PhotoImage(file="visualNovel/I-3.png")
codes = codes.subsample(4)
replit = tk.PhotoImage(file="visualNovel/I-2.png")
replit = replit.subsample(4)
days = tk.PhotoImage(file="visualNovel/I-4.png")
days = days.subsample(4)
amazing = tk.PhotoImage(file="visualNovel/I-5.png")
amazing = amazing.subsample(4)
vs = tk.PhotoImage(file="visualNovel/I-6.png")
vs = vs.subsample(4)
